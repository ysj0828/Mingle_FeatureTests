...
namespace Exoa.Touch
{
    ...
    public class TouchSnapshot
    {
        ...
        public static List<TouchSnapshot> InactiveSnapshots = new List<TouchSnapshot>(1000);

        /// <summary>Return the last inactive snapshot, or allocate a new one.</summary>
        public static TouchSnapshot Pop()
        {
        ...
        public static bool TryGetScreenPosition(List<TouchSnapshot> snapshots, float targetAge, ref Vector2 screenPosition)
        {
        ...
        public static bool TryGetSnapshot(List<TouchSnapshot> snapshots, int index, ref float age, ref Vector2 screenPosition)
        {
        ...
        /// NOTE: This assumes snapshots does not contain any null elements.</summary>
        public static int GetLowerIndex(List<TouchSnapshot> snapshots, float targetAge)
        {
            if (snapshots != null)
            {
