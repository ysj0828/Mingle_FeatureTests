...
namespace CGF.Editor
{
    ...
    public static class CGFEditorUtilitiesExtendedClass
    {
        ...
        /// \endspanish
        public static void BuildBlendTypeEnum(SerializedProperty propertyBlendType, SerializedProperty propertyBlendSource, SerializedProperty propertyBlendDestination, SerializedProperty propertyBlendOpertion, SerializedProperty myMaterial)
        {
            ...
            BlendOperation blendOperation = (BlendOperation)propertyBlendOpertion.floatValue;
            ...
            blendOperation = (BlendOperation)EditorGUILayout.Popup(new GUIContent("Blend Operation", "Blending operation."), (int)blendOperation, blendOperationNames);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                propertyBlendOpertion.floatValue = (float)blendOperation;

                SetBlendType(myMaterial.objectReferenceValue as Material, blendType, blendFactorSource, blendFactorDestination, blendOperation, propertyBlendSource, propertyBlendDestination, propertyBlendOpertion);
        ...
        /// <param name="scrollByTexel">Propiedad desplazamiento por texel.</param>
        /// \endspanish
        internal static void BuildUVScrollSimple(SerializedProperty uvScroll, SerializedProperty flipUVHorizontal, SerializedProperty flipUVVertical, SerializedProperty uvScrollAnimation, SerializedProperty uvScrollSpeed)
        {
            DrawHeaderWithKeyword("UV Scroll", "Description", uvScroll);
        ...
        /// \endspanish
        public static void SetBlendType(Material material, BlendType blendType, BlendFactor blendSource, BlendFactor blendDestination, BlendOperation blendOperation, SerializedProperty propertyBlendSource, SerializedProperty propertyBlendDestination, SerializedProperty propertyBlendOperation)
        {
            ...
            switch (blendType)
            {
                ...
                case BlendType.Custom:
                    ...
                    //material.SetInt("_DstBlend", (int)blendDestination);
                ...
                case BlendType.AlphaBlend:
                    ...
                    propertyBlendOperation.floatValue = (int)UnityEngine.Rendering.BlendOp.Add;               
