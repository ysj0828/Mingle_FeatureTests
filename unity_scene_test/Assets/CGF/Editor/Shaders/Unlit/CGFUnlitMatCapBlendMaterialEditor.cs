...
/// Description: Material editor of the shader Unlit/MatCap Blend.
///
...
/// \english
/// <summary>
/// Material editor of the shader Unlit/MatCap Blend.
/// </summary>
/// \endenglish
/// \spanish
/// <summary>
/// Editor del material del shader Unlit/MatCap Blend.
/// </summary>
/// \endspanish
public class CGFUnlitMatCapBlendMaterialEditor : CGFMaterialEditorClass
{
    ...
    #region Private Variables
        ...
        private bool _blendModeHeaderGroup = true;
    ...
    #region Main Methods
        ...
        public override void Awake() {
            ...
            CGFMaterialEditorUtilitiesClass.SetInitialRenderMode(this.target as Material, "transparent");
        ...
        protected override void InspectorGUI()
        {
            ...
            float useAlphaClip =_RenderMode.floatValue == 0 ? 1 : 0;

            float useAlphaAndAlphaClip = _RenderMode.floatValue == 0 || _RenderMode.floatValue == 1 ? 1 : 0;

            //CGFMaterialEditorUtilitiesClass.BuildMaterialComponent(typeof(CGFUnlitMatCapBlendBehavior));
            ...
            {
                CGFMaterialEditorUtilitiesClass.BuildRenderModeTransparentEnum(_RenderMode, this, false);
                CGFMaterialEditorUtilitiesClass.BuildRenderFace(_Cull);
            }

            GUILayout.Space(5);

            CGFMaterialEditorUtilitiesClass.BuildBlendModeEnum(_BlendMode, this, _blendModeHeaderGroup, m_HeaderStateKey);
            ...
            if (_mainHeaderGroup)
            {
                CGFMaterialEditorUtilitiesClass.BuildTexture("Diffuse Map " + CGFMaterialEditorUtilitiesExtendedClass.CheckRenderModeStandardTransparent(_RenderMode.floatValue), "Main texture.", _MainTex, this, true, _compactMode);
                ...
                CGFMaterialEditorUtilitiesClass.BuildColor("Color " + CGFMaterialEditorUtilitiesExtendedClass.CheckRenderModeStandardTransparent(_RenderMode.floatValue), "Main color.", _Color);
            }
